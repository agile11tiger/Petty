...
namespace Petty.Views.Controls.YinYangSpinner;
...
public class YinYangSpinnerSKCanvasView : SKCanvasView
{
    ...
    public void Draw(SKCanvas canvas, SKRect dirtyRect)
    {
        ...
        blackSkPaint.Shader = SKShader.CreateLinearGradient(
            ...
            [blackSkPaint.Color.WithAlpha(0), blackSkPaint.Color.WithAlpha(100)],
...
/// Delete when this bug is fixed and use <see cref="YinYangSpinnerDrawable"/>. https://github.com/dotnet/maui/issues/14945
/// </summary>
