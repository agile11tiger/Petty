...
public partial class PickerView : ContentView
{
    ...
    public string SelectedItemName { get => (string)GetValue(SelectedItemNameProperty); set => SetValue(SelectedItemNameProperty, value); }
    public ICommand ClosingCommand { get => (ICommand)GetValue(ClosingCommandProperty); set => SetValue(ClosingCommandProperty, value); }
    public Color SelectedItemNameUnderlineColor { get => (Color)GetValue(SelectedItemNameUnderlineColorProperty); set => SetValue(SelectedItemNameUnderlineColorProperty, value); }
