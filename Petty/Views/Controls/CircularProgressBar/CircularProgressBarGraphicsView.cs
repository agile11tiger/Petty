namespace Petty.Views.Controls.CircularProgressBar;
...
public class CircularProgressBarGraphicsView : GraphicsView
{
    ...
    {
        if (bindable is not CircularProgressBarGraphicsView { Drawable: CircularProgressBarDrawable drawable } view)
            return;
