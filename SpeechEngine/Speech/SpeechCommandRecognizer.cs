using SpeechEngine.Localization;
using SpeechEngine.Services;
namespace SpeechEngine.Speech;

public class SpeechCommandRecognizer(NumberParsingService _numberParsingService)
{
    public const int REPEAT_COMMAND_MAX_COUNT = 99;
    public static string SpeechCommandTitle => AppResources.SpeechCommandTitle;
    public static string SpeechCommandIntroduction => AppResources.SpeechCommandIntroduction;
    ...
    public void ApplyCommands(SpeechWords speech)
    {
    ...
    public void AddPunctuation(SpeechWords speech)
    {
        for (var i = 0; i < speech.Length; i++)
        {
    ...
    private string RepeatPunctuation(SpeechWords speech, ref int i, string punctuationMark)
    {
