...
/// </remarks>
public class AudioRecorder(IAudioStream audioStream, WaveRecorder waveRecorder)
{
    private readonly static object _locker = new();
    private readonly IAudioStream _audioStream = audioStream;
    private readonly WaveRecorder _waveRecorderService = waveRecorder;
    ...
    /// <summary>
    /// Returns a value indicating if the <see cref="AudioRecorder"/> is currently recording audio
    /// </summary>
